# Ghidra
 ...
 - [Ghidra's API documentation](https://ghidra.re/ghidra_docs)
...
Script to obtain local variables from a function (taken from [this issue](https://github.com/NationalSecurityAgency/ghidra/issues/2183))
